...
provider "aws" {
 ...
 shared_credentials_files = ["C:/Users/14275239407/.aws/credentials"]
}
...
resource "aws_instance" "linux" {
 ...
 key_name      = "linux" # Não esqueca de gerar a chave  pública e privada para este nome!
...
resource "aws_instance" "windows" {
 ...
 instance_type = "t2.micro"
 key_name      = "wind" # Não esqueca de gerar a chave  pública e privada para este nome!
...
resource "aws_instance" "Linuxlb" {
  ...
  key_name = "linux"                          # Nome da chave SSH utilizada para acessar as instâncias
